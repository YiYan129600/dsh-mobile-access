...
<main>
  ...
  <section class="card beacon">
    ...
    <div style="width:100%;text-align:left;margin-top:6px;display:none" id="http2Panel">
      ...
      <input id="http2host" type="text" placeholder="yiyan.tail172eda.ts.net" style="width:100%;margin-top:6px;padding:9px 12px;background:var(--inset,#0c141b);border:1px solid var(--line);border-radius:9px;color:var(--text);font:13px ui-monospace,Consolas,monospace">
