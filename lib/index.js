...
<style>
  ...
  *{box-sizing:border-box;margin:0;padding:0}
  ...
  button{font:600 12px/1 ui-monospace,Consolas,monospace;color:var(--bg);background:var(--amber);border:none;border-radius:7px;padding:8px 14px;cursor:pointer;letter-spacing:.05em}
